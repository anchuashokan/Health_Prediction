...
public class email {
    ...
    public static void main(String[] args) {
        ...
        try {
            mailer.email(host, port, mailFrom, password, mailTo,
                    subject, message);
	...
	private void email(String host, String port, String mailFrom, String password, String mailTo, String subject,
			String message) {
